...
module "rds" {
  source = "git::https://github.com/manoj531222/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/manoj531222/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/manoj531222/tf-module-amazon-mq.git"
...
#module "alb" {
#  source = "git::https://github.com/manoj531222/tf-module-alb.git"
#
#  for_each       = var.alb
#  subnets        = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["subnet_name"], null), "subnet_ids", null)
...
#}
module "eks" {
  source             = "git::https://github.com/manoj531222/tf-module-eks.git"
  ENV                = var.env
  eks_version = 1.27
...
#  vpc_security_group_ids = ["sg-08bcece2af26f1c2b"]
#  tags = {
#    Name = "load-runner"
#  }
#}
